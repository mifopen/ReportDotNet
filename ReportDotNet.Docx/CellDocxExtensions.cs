...
namespace ReportDotNet.Docx
{
	...
	{
		public static TableCell Convert(this Cell cell, WordprocessingDocument document, Table table, int span)
		{
		...
		private static TBorder GetBorder<TBorder>(BorderStyle borderStyle, double? borderSize) where TBorder: BorderType, new()
		{
			return new TBorder
				   {
		...
		private static TableCellMargin GetMargin(int? left, int? right)
		{
