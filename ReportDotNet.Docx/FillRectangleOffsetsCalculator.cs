...
namespace ReportDotNet.Docx
{
    internal static class FillRectangleOffsetsCalculator
    {
        ...
        public static Offsets Calculate(Size imageSize,
        ...
        private static Offsets CenterVertical(Size imageSize,
                                              Size placeholderSize)
        {
        ...
        private static Offsets CenterHorizontal(Size imageSize,
                                                Size placeholderSize)
        {
        ...
        private static double PercentOf(double value,
                                        double of)
        {
            return value / of * 100;
        }
