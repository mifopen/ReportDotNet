...
namespace ReportDotNet.Docx
{
	...
	{
		public static OpenXmlElement Convert(this Table table, WordprocessingDocument document)
		{
		...
		private static DocumentFormat.OpenXml.Wordprocessing.Table CreateTable(float width, int[] columnWidths)
		{
