...
namespace ReportDotNet.Playground.Template.PaymentOrderExample
{
	public static class Template
	{
		...
		private static void FillDocument(IDocument document, Data[] cashOrders)
		{
		...
		private static PageBuilder GetPage(Data data)
		{
			...
			Func<string, bool, bool, Cell[]> cutFunc = (s, down, up) =>
														   new[]
															   {
																   Factories.Cell(5)
																			.Margin(0, 0)
		...
		private static readonly Func<int?, string, Cell> remarkCell = (w, s) =>
																		  Factories.Cell(s, w)
		...
		private static readonly Func<int?, string, bool, bool, Cell> headerCell = (w, s, down, up) =>
																					  Factories.Cell(s, w)
																							   .FontSize(7)
																							   .Margin(0, 0)
																							   .Alignment(Alignment.Center)
